// src/lib.rs
/*
 * Core library for BackendExpress
 */
...
#[derive(Debug)]
pub struct BackendExpressProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BackendExpressProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BackendExpress processing");
    
    let mut processor = BackendExpressProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BackendExpressProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BackendExpressProcessor::new(false);
